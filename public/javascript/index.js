...
window.addEventListener('load', () => {
	// Fetch all registers
	document.getElementById('delete-all').addEventListener('click', charactersAPI.deleteAll)
	...
	document.getElementById('fetch-one').addEventListener('click', function (event) {
		...
		charactersAPI
			...
			.then(response => {
				document.querySelector('#singleCharacter').innerHTML = `<div class="character-info">
	...
	document.getElementById('edit-character-form').addEventListener('submit', function (event) {
		...
		charactersAPI
			...
			.then(updatedCharacter =>
				charactersAPI.updateOneRegister(wantedId, updatedCharacter).then(() => {
	...
	document.getElementById('new-character-form').addEventListener('submit', function (event) {
		event.preventDefault()
		const inputCharacter = document.querySelectorAll('#new-character-form input')
